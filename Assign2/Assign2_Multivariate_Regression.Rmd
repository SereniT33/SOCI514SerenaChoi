...
In order to answer the *first research question*, we will look at three models with decommodification as the response variable. **Model 1** is the bivariate model that we created in the Assignment 1, with left politics as an independent variable. 
